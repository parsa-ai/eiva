          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              ...
              <div
                ...
                className="group relative bg-slate-800/70  rounded-2xl overflow-hidden border border-slate-700/50 hover:border-emerald-500/50 transition-colors duration-500 hover:shadow-`xl hover:shadow-emerald-500/10"
                onClick={() => {
                  setIsHide(false);
                  setindexOfPrj(index)
                }}
...
function Modal({ indexOfPrj, isHide, setIsHide }: { indexOfPrj: number, isHide: boolean, setIsHide: (a: boolean) => void }) {
